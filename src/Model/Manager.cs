...
public class Manager
{
    ...
    public ReadOnlyCollection<Player> LoadAllPlayer() => _dataManager.LoadAllPlayer();
    ...
    /// <returns>List of players</returns>
    public ReadOnlyCollection<Player> LoadPlayersByGroup(Group group) => _dataManager.LoadPlayersByGroup(group);
    ...
    /// <returns>List of players</returns>
    public ReadOnlyCollection<Player> LoadPlayerByFirstName(string firstName) => _dataManager.LoadPlayerByFirstName(firstName);
    ...
    /// <returns>List of players</returns>
    public ReadOnlyCollection<Player> LoadPlayerByLastName(string lastName) => _dataManager.LoadPlayerByLastName(lastName);
    ...
    /// <returns>List of players</returns>
    public ReadOnlyCollection<Player> LoadPlayerByNickname(string nickname) => _dataManager.LoadPlayerByNickname(nickname);
    ...
    /// <param name="lastName">Lastname to search</param>
    /// <returns>List of players</returns>
    public ReadOnlyCollection<Player> LoadPlayerByFirstNameAndLastName(string firstName, string lastName) => _dataManager.LoadPlayerByFirstNameAndLastName(firstName, lastName);
    ...
    /// <param name="nickname">nickname to search</param>
    /// <returns>List of players</returns>
    public ReadOnlyCollection<Player> LoadPlayerByFirstNameAndNickname(string firstName, string nickname) => _dataManager.LoadPlayerByFirstNameAndNickname(firstName, nickname);
    ...
    /// <param name="nickname">nickname to search</param>
    /// <returns>List of players</returns>
    public ReadOnlyCollection<Player> LoadPlayerByLastNameAndNickname(string lastName, string nickname) => _dataManager.LoadPlayerByLastNameAndNickname(lastName, nickname);
    ...
    public Player CreatePlayer(string firstName, string lastName, string nickname, string avatar) => new Player(firstName, lastName, nickname, avatar);
    /*========== End player ==========*/
    ...
    public ReadOnlyCollection<Game> LoadGameByStartDate(DateTime startDate) => _dataManager.LoadGameByStartDate(startDate);
    ...
    /// <returns>List of games</returns>
    public ReadOnlyCollection<Game> LoadGameByEndDate(DateTime endDate) => _dataManager.LoadGameByEndDate(endDate);
    ...
    /// <returns>List of games</returns>
    public ReadOnlyCollection<Game> LoadGameByDateInterval(DateTime startDate, DateTime endDate) => _dataManager.LoadGameByDateInterval(startDate, endDate);
    ...
    /// <param name="group">Group to search</param>
    /// <returns>List of games</returns>
    public ReadOnlyCollection<Game> LoadGameByDateAndGroupInterval(DateTime startDate, DateTime endDate, Group group) => _dataManager.LoadGameByDateAndGroupInterval(startDate, endDate, group);
    ...
    /// <returns>List of games</returns>
    public ReadOnlyCollection<Game> LoadGameByDateAndPlayerInterval(DateTime startDate, DateTime endDate, Player player) => _dataManager.LoadGameByDateAndPlayerInterval(startDate, endDate, player);
    ...
    /// <param name="player">Player to search</param>
    /// <returns>List of games</returns>
    public ReadOnlyCollection<Game> LoadGameByPlayer(Player player) => _dataManager.LoadGameByPlayer(player);
    ...
    /// <param name="group">Group to search</param>
    /// <returns>List of games</returns>
    public ReadOnlyCollection<Game> LoadGameByGroup(Group group) => _dataManager.LoadGameByGroup(group);
    
    /// <summary>
    /// Method to load all games
    /// </summary>
    /// <returns>List of games</returns>
    public ReadOnlyCollection<Game> LoadAllGames() => _dataManager.LoadAllGames();
    ...
    public Game CreateGame(string name, DateTime startDate) => new Game(name, startDate);
    /*========== End game ==========*/
    ...
    public ReadOnlyCollection<IRules> LoadAllRules() => _dataManager.LoadAllRules();
    /*========== End rules ==========*/
    ...
    public ReadOnlyCollection<Group> LoadAllGroups() => _dataManager.LoadAllGroups();
    ...
    /// <param name="player">Player to search</param>
    /// <returns>List of groups</returns>
    public ReadOnlyCollection<Group> LoadGroupsByPlayer(Player player) => _dataManager.LoadGroupsByPlayer(player);
    ...
    public Hand CreateHand(long id, int handNumber, IRules rules, DateTime date, int takerScore, bool? twentyOne, bool? excuse, PetitResult petit, params KeyValuePair<Player,(Bidding, Poignee)>[] biddings) => new Hand(id, handNumber, rules, date, takerScore, twentyOne, excuse, petit, biddings);
    /*========== End hand ==========*/
}